...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
            await idk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
            await adk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@OFICIAL_SPAM_BOT"))
            await edk(functions.channels.JoinChannelRequest(channel="@BLACK_GHOULS_OP_SPAM"))
...
print(text)
print("")
print("SMEX! Ghouls Multi Spam Bot Started Sucessfully.")
